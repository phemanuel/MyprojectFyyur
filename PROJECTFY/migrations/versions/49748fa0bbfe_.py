...
Revision ID: 49748fa0bbfe
Revises: 
Create Date: 2022-06-03 03:32:35.252636
...
def upgrade():
    ...
    sa.Column('noofalbum', sa.Integer(), nullable=False),
    sa.Column('nameyear', sa.String(length=500), nullable=False),
    sa.Column('albumtrack', sa.String(length=500), nullable=False),
